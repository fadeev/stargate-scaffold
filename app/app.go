...
import (
	...
	"github.com/foo/foo/x/foo"
	fookeeper "github.com/foo/foo/x/foo/keeper"
...
func New(
	...
	app.fooKeeper = *fookeeper.NewKeeper(
        appCodec, keys[footypes.StoreKey], keys[footypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		foo.NewAppModule(appCodec, app.fooKeeper),
