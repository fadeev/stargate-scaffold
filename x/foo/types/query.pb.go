...
func (*QueryGetPostRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_78a1dbe23c870d63, []int{0}
}
...
func (*QueryGetPostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_78a1dbe23c870d63, []int{1}
}
...
func (*QueryAllPostRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_78a1dbe23c870d63, []int{2}
}
...
func (*QueryAllPostResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_78a1dbe23c870d63, []int{3}
}
...
func init() {
	proto.RegisterType((*QueryGetPostRequest)(nil), "foo.foo.QueryGetPostRequest")
	proto.RegisterType((*QueryGetPostResponse)(nil), "foo.foo.QueryGetPostResponse")
	proto.RegisterType((*QueryAllPostRequest)(nil), "foo.foo.QueryAllPostRequest")
	proto.RegisterType((*QueryAllPostResponse)(nil), "foo.foo.QueryAllPostResponse")
}
...
var fileDescriptor_78a1dbe23c870d63 = []byte{
	...
	,
}
...
func (c *queryClient) Post(ctx context.Context, in *QueryGetPostRequest, opts ...grpc.CallOption) (*QueryGetPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/foo.foo.Query/Post", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) PostAll(ctx context.Context, in *QueryAllPostRequest, opts ...grpc.CallOption) (*QueryAllPostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/foo.foo.Query/PostAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_PostAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/foo.foo.Query/PostAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
